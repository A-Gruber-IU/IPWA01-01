...
export default function Abgabe({ handleBestaetigung }) {
    ...
    function neuesKleiderstueck(event) {
        ...
        if (kleiderArray.length < 501) {
            ...
            alert('Du hast das Limit an Kleidungsstücken für eine einzelne Abgabe erreicht. Falls du wirklich noch mehr abgeben willst, setze dich dafür direkt mit uns in Verbindung.');
        }
    }
    ...
    async function handleSubmit(event) {
        ...
        if (!meinForm.checkValidity()) {
            ...
            let sendeDaten = { "Logistik": "Abgabe" };
